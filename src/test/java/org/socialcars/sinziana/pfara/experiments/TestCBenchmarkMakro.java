...
public class TestCBenchmarkMakro
{
    ...
    {
        m_benchmakro = new CBenchmarkMakro( "src/test/resources/tiergartenN.json", "src/test/resources/tiergartenN_info.json", "TiergartenNOptBenchmarkMakro_5veh", 1, 0.01 );
    }
