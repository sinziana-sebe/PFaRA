...
public class TestCScenarioGeneration
{
    ...
    {
        m_scengen = new CScenarioGeneration( "src/test/resources/tiergarten_demand.json", "src/test/resources/tiergarten.json", 0.1, 1 );
    }

    @Test
    public void  generate() throws IOException
    {
        m_scengen.generateDensityFlow( 8, "tiergartenR_info.json" );
    }
}
